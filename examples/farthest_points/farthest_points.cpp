...
#include <cg/algo/farthest_points.h>
#include <cmath>

using cg::point_2f;
using cg::point_2;

struct farthest_points_viewer : cg::visualization::viewer_adapter
{
    farthest_points_viewer() : found(false)
   {}
   ...
   void build() {
       result = cg::farthest_points(points.begin(), points.end());
       found = true;
   }
...
int main(int argc, char ** argv)
{
   ...
   farthest_points_viewer viewer;
   cg::visualization::run_viewer(&viewer, "farthest points");
}
