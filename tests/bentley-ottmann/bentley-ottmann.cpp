...
TEST(simple, test2)
{
   vector<segment_2d> segments;
   segments.push_back(segment_2d(point_2(0.0, 0.0), point_2(10.0, 10.0)));
   segments.push_back(segment_2d(point_2(0.0, 10.0), point_2(10.0, 0.0)));
   vector<point_2> result;
   result.push_back(point_2(5.0, 5.0));
   vector<point_2> res = cg::segments_intersection(segments);
...
TEST(less_function, test1) {
   ...
   new_point p2(segment_2d(point_2(-1.0, -1.0), point_2(1.0, 1.0)), segment_2d(point_2(-1.0, 1.0), point_2(1.0, -1.0)));
